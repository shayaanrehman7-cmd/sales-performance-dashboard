...
Leads Generated & Deals Closed — pipeline volume tracking
Conversion Rate (%) — deals closed as a percentage of leads generated
...
Conditional number formatting (currency, percentages, thousands separator)
Auto-filter and freeze panes on raw data
Line charts, bar charts and pie charts with custom formatting
KPI card layout using merged cells and conditional colour coding
...
Regional performance was broadly even, indicating no single region is significantly over- or under-performing — opportunity for targeted growth campaigns
...
🐍 Python Course — Code Basics (in progress)
🗄️ Intro to SQL — Codecademy
📊 Learn Microsoft Excel for Data Analysis — Codecademy
🎓 Masters in Business in IT — WSB Merito University (in progress)

This project bridges my commercial experience with my growing analytical skill set — demonstrating that I can not only understand sales data from having worked in the field, but also structure, analyse and present it effectively.

📬 Contact
Shayaan Rehman
📧 shayaanrehman7@gmail.com
